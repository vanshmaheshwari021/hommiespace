...
export const Hero3DCanvas: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full min-h-[480px] bg-brand-sand-light dark:bg-brand-charcoal overflow-hidden group border border-brand-sand-dark/20 dark:border-brand-sand-dark/10 shadow-2xl">
      {/* Editorial High-Resolution Living Room Showroom Image */}
      <img 
        src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1600&q=80" 
        alt="Scandinavian Quiet Luxury Living Space" 
      ...
      {/* Interactive 3D Parallax Hotspot Markers */}
      {HOTSPOTS.map((spot) => (
        <div
          key={spot.id}
        ...
        >
          ...
          >
            ...
            <button 
              type="button" 
              className="w-8 h-8 rounded-full bg-white/90 dark:bg-brand-walnut/90 shadow-2xl border border-brand-terracotta/50 flex items-center justify-center animate-pulse hover:scale-125 transition-all cursor-pointer"
            >
